...
val ROUTE_1 = Route(id = "1", rating = 4.0, name = "Историческая часть города", cost = "0 - 500", imageUrl = "https://cdn.culture.ru/images/80aee2a7-ead2-5308-a550-b2c49109f906", favourite = true)

val ROUTES = listOf(ROUTE_1, ROUTE_1.copy(id = "2"), ROUTE_1.copy(id = "3"))

val ROUTE_FULL = RouteFull(
    id = "1",
